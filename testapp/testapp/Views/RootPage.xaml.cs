...
namespace testapp.Views
{
	public partial class RootPage : MasterDetailPage
	{
		...
		public RootPage()
		{
			...
			var page1 = new ViewModels.MenuPageViewModel() { Title = "Kaart", Icon = "map_location.png", TargetType = typeof(MapPage) };
            ...
            var weer = new ViewModels.MenuPageViewModel() { Title = "Weer", Icon = "sun.png", TargetType = typeof(WeatherPage) };
            var news = new ViewModels.MenuPageViewModel() { Title = "Nieuws", Icon = "newspaper.png", TargetType = typeof(RssFeedPage) };
            var loginPage = new ViewModels.MenuPageViewModel() { Title = "Inloggen", Icon = "login.png", TargetType = typeof(LoginPage)};
            var logoutPage = new ViewModels.MenuPageViewModel() { Title = "Uitloggen", Icon = "logout.png", TargetType = typeof(LogoutPage) };
